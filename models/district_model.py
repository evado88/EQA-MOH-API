...
class DistrictDB(Base):
    ...
    #relationships
    user = relationship("UserDB", back_populates="districts", foreign_keys=[user_id], lazy='raise')
    status = relationship("StatusDB", back_populates="district", lazy='raise')
    stage = relationship("StageDB", back_populates="district", lazy='raise')
    province = relationship("ProvinceDB", back_populates="district", lazy='raise')

    #links
    laboratory = relationship("LaboratoryDB", back_populates="district", lazy='raise')
...
class ParamDistrictEdit(BaseModel):
    district: Optional[DistrictWithDetail] = None
